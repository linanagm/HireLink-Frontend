				...
				<div className="container mx-auto px-6 max-w-5xl">
					<div className="text-center mb-12">
						...
						<p className="text-gray-600 max-w-2xl mx-auto">
							We build meaningful digital experiences that connect people with
							real opportunities.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-2 gap-10 items-center">
						...
						<div>
							...
							<p className="text-gray-600 leading-relaxed mb-6">
								Our goal is to create a platform that simplifies hiring and job
								searching. We believe technology should remove barriers, not add
								new ones.
							</p>
