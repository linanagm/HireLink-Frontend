...
const Dashboard = () => {
  ...
  const jobs = [
    { id: 1, title: 'UI/UX Designer', posted: 'Mar 20, 2025', status: 'Open', applicants: 10 },
    { id: 2, title: 'Frontend Developer', posted: 'Mar 5, 2025', status: 'Closed', applicants: 52 },
    { id: 3, title: 'Data Analyst', posted: 'Jun 5, 2025', status: 'Open', applicants: 18 },
    { id: 4, title: 'Sales Executive', posted: 'Aug 30, 2025', status: 'Open', applicants: 20 },
    { id: 5, title: 'Content Writer', posted: 'Sep 15, 2025', status: 'Pending', applicants: 15 },
  ];

  const applicants = [
    { id: 1, name: 'Hana A.', job: 'UI/UX Designer', date: 'Apr 27, 2025', status: 'Under Review' },
    { id: 2, name: 'Liam R.', job: 'Frontend Developer', date: 'Apr 30, 2025', status: 'Interview' },
    { id: 3, name: 'Sofia M.', job: 'Product Manager', date: 'May 2, 2025', status: 'Received' },
    { id: 4, name: 'Ethan K.', job: 'Data Analyst', date: 'May 5, 2025', status: 'Under Review' },
    { id: 5, name: 'Aria J.', job: 'Marketing Specialist', date: 'May 8, 2025', status: 'Offer' },
  ];
  ...
  return (
    <div style={{ padding: '20px', backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
      ...
      <p style={{ color: '#666', marginBottom: '20px' }}>Manage jobs and applicants</p>
      ...
      <div style={{ marginBottom: '20px', borderBottom: '1px solid #ddd' }}>
        ...
        <button 
          ...
          style={{
            padding: '10px 20px',
            backgroundColor: activeTab === 'applicants' ? 'white' : 'transparent',
            ...
            {talents.map((t, i) => (
              <div key={i} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <img src={t.img} style={{ width: '50px', height: '50px', borderRadius: '50%' }} />
                  <div>
