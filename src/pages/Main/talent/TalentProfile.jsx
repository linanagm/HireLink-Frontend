...
export default function EditableProfile() {
  ...
  const [profile, setProfile] = useState({
    ...
    skills: ["UX/UI Design", "HTML5, CSS3, JavaScript", "Responsive Web Design"],
    work: "No experience",
            ...
            <div className="space-y-3">
              <input
                ...
                onChange={(e) =>
                  setProfile({
                    ...profile,
                    certification: { ...profile.certification, title: e.target.value },
                  })
                }
              />
              <input
                ...
                onChange={(e) =>
                  setProfile({
                    ...profile,
                    certification: { ...profile.certification, provider: e.target.value },
                  })
                }
              />
              <input
                ...
                onChange={(e) =>
                  setProfile({
                    ...profile,
                    certification: { ...profile.certification, issued: e.target.value },
                  })
                }
              />
              <input
                ...
                onChange={(e) =>
                  setProfile({
                    ...profile,
                    certification: { ...profile.certification, id: e.target.value },
                  })
                }
              />
              <button
