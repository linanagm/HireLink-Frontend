...
import { UsersGrowthChart, ActivityStateChart } from "../../../components/Admin/Dashboard/Charts.jsx";
      ...
      <div className="mx-auto flex min-h-screen max-w-7xl bg-white shadow-xl my-16">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
          ...
          <div className="mt-6 grid gap-4 lg:grid-cols-2">
            <Card title="Analytics Overview" right={<Badge variant="slate">Last 30d</Badge>}>
              <UsersGrowthChart />
            </Card>
            <Card title="Activity Stats" right={<Badge variant="slate">Last 30d</Badge>}>
              <ActivityStateChart />
            </Card>
          </div>
        </main>
