  ...
  const jobs = [
    {
      ...
      desc:
        "Looking for a creative UI/UX Designer to enhance user experience for our mobile application. Must possess strong design skills and experience with prototyping tools.",
      payment: "Hourly",
      budget: "$50/hr",
      workType: "Hybrid",
      level: "Intermediate",
    ...
    },
    {
      ...
      desc:
        "We need a Data Analyst to help drive insights for marketing efforts and improve business decisions.",
      payment: "Monthly",
      budget: "$3000/month",
      workType: "Remote",
      level: "Senior",
  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      <div className="flex-grow px-10 pt-10">
        ...
        {/* BACK BUTTON */}
        <div className="mb-4">
          <Link to="/talent/findjob" className="text-purple-600 hover:underline">
            ← Back to Jobs
          </Link>
        </div>
