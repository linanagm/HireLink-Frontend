...
export default function Spinner({ size = "w-8 h-8", color = "text-purple-600" }) {
      ...
      >
        ...
        <path
          ...
          d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 
             ...
             0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 
             4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 
             10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 
             65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 
