...
{/* cotrolors */}
        ...
        <button
          ...
          aria-label="Previous"
        >
          <span className=""><i className="fa-solid fa-arrow-left text-slate-600"></i></span>
        </button>
          ...
          {items.map((_, i) => (
            <button
              ...
              className={` h-2 rounded-full transition-all duration-300 ${
                i === active ? "w-6 bg-fuchsia-700" : "w-2 bg-gray-300 hover:bg-gray-400"
              }`}
        ...
        <button
          ...
          aria-label="Next"
        >
          <span className=""><i className="fa-solid fa-arrow-right text-slate-600"></i></span>
        </button>
        </div>
      </div>
    </section>
