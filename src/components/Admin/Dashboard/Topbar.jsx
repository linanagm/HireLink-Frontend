		...
		<div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
			<div>
				...
				<p className="mt-1 text-sm text-slate-600">
					Manage Talent and Employer users, review statuses, and track
					analytics.
				</p>
			</div>
			...
			<div className="flex items-center gap-2">
				...
				<button
					type="button"
					className="hidden sm:inline-flex items-center rounded-2xl bg-white px-4 py-2.5 text-sm font-bold text-slate-700 shadow-sm ring-1 ring-slate-200 hover:bg-slate-50"
				>
					Search
				</button>
