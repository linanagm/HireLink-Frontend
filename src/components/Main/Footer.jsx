			...
			<div className="absolute inset-0 h-full text-center mx-auto w-full max-w-screen-xl p-4 py-6 px-11lg:py-8 ">
				<div className="flex flex-col md:flex-row md:justify-between md:items-center">
					...
					<div className="flex  sm:gap-6 text-sm  px-10  ">
						{/* company section */}
						<div className="w-60">
							<h2 className="mb-6 text-sm font-normal text-heading   !important font-">
								Company
							</h2>
							...
							<ul className="text-body">
								<li className="mb-4">
									<NavLink
										to={"/about"}
										className="text-white text-xs !important hover:underline"
									>
										About Us
									</NavLink>
								</li>
								<li>
									<NavLink to={"/contact"} className=" text-xs hover:underline">
										Contact Us
									</NavLink>
								</li>
							</ul>
						...
						{/* support us section */}
						<div className=" w-60">
							<h2 className="mb-6 text-sm font-normal text-heading ">
								Support us
							</h2>
