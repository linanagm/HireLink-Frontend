...
//     console.log('current user navbar: \n' , currentUser);
//     //handle profile avatar toggle
//     const toggleProfile = () => {
...
//         {to: "/jobs/:jobId/applicants/search", label: "Search Talents"},
...
//     <nav className="bg-neutral-primary flex flex-wrap w-full h-16 max-w-screen-2xl z-20 border-b border-default mx-auto p-4 justify-between items-center">
//       {/* LEFT SECTION */}
//       <div className="flex items-center gap-7 w-1/2">
//         <NavLink to="/" className="flex items-center space-x-2">
//           <img src={logo} className="h-7" alt="HireLink Logo" />
//           <span className="text-xl font-semibold text-heading">HireLink</span>
//         </NavLink>

//         {/* NAV TABS (Desktop) */}
//         <div className="hidden md:flex">
//           <ul className="flex font-medium md:space-x-8 p-0">
//             {tabs.map(tab => (
//               <li key={tab.to}>
//                 <NavLink
//                   to={tab.to}
//                   className="block py-2 text-neutral-800 hover:text-fuchsia-800"
//                 >
//                   {tab.label}
//                 </NavLink>
//               </li>
...
//               {openNotify && (
//                 <div className="absolute right-0 mt-2 w-72 bg-white shadow-lg rounded-xl border">
//                   <ul className="p-2">
//                     <li>
...
//                       <Link
//                         to="/talent/profile/settings"
//                         className="flex items-center text-gray-600 p-2 hover:bg-slate-100  hover:text-gray-900"
//                       >
...
//                         className="flex items-center p-2 text-red-600 hover:bg-gray-100 cursor-pointer"
//                       >
