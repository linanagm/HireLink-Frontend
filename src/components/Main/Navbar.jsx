  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 ">
      ...
      <div className="items-center justify-between hidden  md:flex md:w-auto md:order-1 " id="navbar-cta">
        ...
        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-default rounded-base bg-neutral-secondary-soft md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-neutral-primary">
          ...
          <li>
            <a href="home" className="block py-2 px-3  bg-brand rounded md:bg-transparent md:text-fg-brand md:p-0  text-fuchsia-800 hover:text-fuchsia-600" aria-current="page">Home</a>
          </li>
      
          <li>
            <a href="about" className="block py-2 px-3 text-heading rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0 md:dark:hover:bg-transparent  text-fuchsia-800 hover:text-fuchsia-600">About</a>
          </li>
      
          <li>
            <a href="contact" className="block py-2 px-3 text-heading rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0 md:dark:hover:bg-transparent  text-fuchsia-800 hover:text-fuchsia-600">Contact</a>
          </li>
